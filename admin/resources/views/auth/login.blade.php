...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; }
        body {
            min-height: 100vh;
            background: url('{{ \App\Models\SiteSetting::get("login_bg") ?: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=1920&q=80" }}') no-repeat center center fixed;
...
<body class="flex items-center justify-center min-h-screen p-4 relative z-10">
    ...
    <div class="login-loader" id="loginLoader">
        <img src="{{ asset('assets/img/simbole.png') }}" alt="Loading" class="login-loader-logo" />
    ...
    <div class="card rounded-2xl p-10 w-full max-w-sm relative">
        ...
        <div class="flex flex-col items-center">
            ...
            <div class="mb-5">
                <img src="{{ asset('assets/img/simbole.png') }}" alt="TSHOOT" class="h-14 w-14 object-contain mx-auto">
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="w-full" id="loginForm">
                @csrf
