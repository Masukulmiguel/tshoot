    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div id="contacts-list" class="divide-y divide-gray-50">
            @forelse($recentContacts as $contact)
                <a href="{{ route('admin.contacts.show', $contact) }}" class="table-row flex items-center gap-5 pl-10 pr-7 py-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div id="visitors-list" class="divide-y divide-gray-50">
            @forelse($recentVisitors as $visitor)
                    <a href="{{ route('admin.visitors.show', $visitor) }}" class="table-row flex items-center gap-5 pl-10 pr-7 py-6">
