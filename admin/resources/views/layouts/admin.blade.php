        ...
        <nav class="flex-1 py-4 overflow-y-auto">
            ...
            <a href="{{ route('admin.dashboard') }}"
               class="nav-link flex items-center gap-3 px-6 py-3 text-gray-300 hover:text-white {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('admin.dashboard') ? 'text-gold' : '' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.contacts.index') }}"
               class="nav-link flex items-center justify-between px-6 py-3 text-gray-300 hover:text-white {{ request()->routeIs('admin.contacts.*') ? 'active' : '' }}">
                <div class="flex items-center gap-3">
                    <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('admin.contacts.*') ? 'text-gold' : '' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.visitors.index') }}"
               class="nav-link flex items-center justify-between px-6 py-3 text-gray-300 hover:text-white {{ request()->routeIs('admin.visitors.*') ? 'active' : '' }}">
                <div class="flex items-center gap-3">
                    <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('admin.visitors.*') ? 'text-gold' : '' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.images.index') }}"
               class="nav-link flex items-center gap-3 px-6 py-3 text-gray-300 hover:text-white {{ request()->routeIs('admin.images.*') ? 'active' : '' }}">
                <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('admin.images.*') ? 'text-gold' : '' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.services.index') }}"
               class="nav-link flex items-center gap-3 px-6 py-3 text-gray-300 hover:text-white {{ request()->routeIs('admin.services.*') ? 'active' : '' }}">
                <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('admin.services.*') ? 'text-gold' : '' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.team.index') }}"
               class="nav-link flex items-center gap-3 px-6 py-3 text-gray-300 hover:text-white {{ request()->routeIs('admin.team.*') ? 'active' : '' }}">
                <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('admin.team.*') ? 'text-gold' : '' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.posts.index') }}"
               class="nav-link flex items-center gap-3 px-6 py-3 text-gray-300 hover:text-white {{ request()->routeIs('admin.posts.*') ? 'active' : '' }}">
                <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('admin.posts.*') ? 'text-gold' : '' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
