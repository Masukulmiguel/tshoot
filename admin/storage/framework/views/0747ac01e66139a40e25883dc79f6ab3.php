...
<div class="p-6 max-w-xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        <a href="<?php echo e(route('admin.images.index')); ?>" class="text-gray-400 hover:text-gray-600">
    ...
    <?php endif; ?>
    <form action="<?php echo e(route('admin.images.store')); ?>" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        <?php echo csrf_field(); ?>
        <div class="mb-4">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tshoot-angola\admin\resources\views/admin/images/create.blade.php ENDPATH**/ ?>