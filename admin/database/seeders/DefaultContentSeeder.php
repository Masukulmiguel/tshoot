...
class DefaultContentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        if (Service::count() === 0) {
            Service::create(['icon' => 'fas fa-tools', 'title' => 'Assistência Técnica', 'slug' => 'assistencia-tecnica', 'description' => 'Diagnóstico e reparação profissional de computadores, impressoras e equipamentos de rede.', 'sort_order' => 1, 'is_active' => true]);
            Service::create(['icon' => 'fas fa-laptop-code', 'title' => 'Desenvolvimento de Software', 'slug' => 'desenvolvimento-de-software', 'description' => 'Aplicações web, mobile e desktop à medida para automatizar os seus processos.', 'sort_order' => 2, 'is_active' => true]);
            Service::create(['icon' => 'fas fa-network-wired', 'title' => 'Infraestrutura', 'slug' => 'infraestrutura', 'description' => 'Instalação e manutenção de redes, servidores, cabeamento estruturado e cloud.', 'sort_order' => 3, 'is_active' => true]);
            Service::create(['icon' => 'fas fa-microchip', 'title' => 'Reparação de Equipamentos', 'slug' => 'reparacao-de-equipamentos', 'description' => 'Reparação especializada de hardware, substituição de componentes e actualizações.', 'sort_order' => 4, 'is_active' => true]);
            Service::create(['icon' => 'fas fa-graduation-cap', 'title' => 'Formação', 'slug' => 'formacao', 'description' => 'Cursos de informática para empresas e particulares, desde nível básico ao avançado.', 'sort_order' => 5, 'is_active' => true]);
            Service::create(['icon' => 'fas fa-shield-alt', 'title' => 'Segurança', 'slug' => 'seguranca', 'description' => 'Soluções de segurança informática, antivirus, firewall e backup de dados.', 'sort_order' => 6, 'is_active' => true]);
            Service::create(['icon' => 'fas fa-print', 'title' => 'Impressoras', 'slug' => 'impressoras', 'description' => 'Venda, manutenção e reparação de impressoras de todos os modelos e marcas.', 'sort_order' => 7, 'is_active' => true]);
            Service::create(['icon' => 'fas fa-headset', 'title' => 'Suporte Remoto', 'slug' => 'suporte-remoto', 'description' => 'Assistência técnica à distância para resolução rápida de problemas.', 'sort_order' => 8, 'is_active' => true]);
        }
